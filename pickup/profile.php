<?php
    ...
    <html>
        ...
        {
            $sql1="update deliveryman set name='$_POST[name]',phone='$_POST[phone]',address='$_POST[address]' where name='$_SESSION[pickupname]'";
            $qry1=mysqli_query($conn,$sql1);
            if($qry1)
            {
                echo "<script>alert('".$_SESSION['pickupname']." Profile Updated Successfully.');window.location='home.php?page=profile'</script>";
            }
            else
            {
        ...
        {
            $sql1="select password from deliveryman where name='$_SESSION[pickupname]'";
            $qry1=mysqli_query($conn,$sql1);
            if($qry1)
            {
                ...
                if($row['password']==$_POST['old'])
                {
                    ...
                    {
                        $sql2="update deliveryman set password='$_POST[re]'";
